							...
							<CardBody>
								<Stack divider={<StackDivider />} spacing='5'>
									<Box>
										...
										<Text pt='2' fontSize='sm'>
											Estimated Loan term, monthly payment
											and APR are all based on approved
											credit. Your actual APR, monthly
											payment and loan term could change
											depending on your actual credit and
											amount financed.
										</Text>
									</Box>
									<Box>
										...
										<Text pt='2' fontSize='sm'>
											...
											Satellite radio trial duration with
											used vehicle purchase is only for 3
											months, irrespective of what shows
										...
										<List spacing={3} mt={2}>
											<ListItem>
												<ListIcon
													...
													color='green.500'
												/>
												Navigation system Lane departure
											</ListItem>
											<ListItem>
												<ListIcon
													as={MdCheckCircle}
